    ...
    fetch(`/news?url=${url}`)
        ...
        .then(data => {
            ...
            if (data.twoDigitFrequency) {
                const twoDigitTable = createFrequencyTable(data.twoDigitFrequency, "Two-digit Frequency");
                resultDiv.innerHTML += twoDigitTable;
            }

            if (data.threeDigitFrequency) {
                const threeDigitTable = createFrequencyTable(data.threeDigitFrequency, "Three-digit Frequency");
